...
- *Blocking* - `In programming blocking is referred to when the code is waiting for something else to happen (computation, user input, request return etc) before moving onto the next line of code`
...
## Exercises
1.  Create a program that prompts the user for their name. Once the name is received replay a greeting that includes their name.
